function [AllRandomisePath] = randomise_psom(AllTBSS_Paths,labelNumVec,NumPerm,Clobber,Label)
...
logs_fd = fullfile(pwd,'logs');

if ~exist(logs_fd,'dir')
    mkdir(logs_fd)
end

opt.path_logs = logs_fd;
opt.mode = 'background';
